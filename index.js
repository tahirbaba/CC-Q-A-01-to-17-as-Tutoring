...
let famousePerson = "Allama Iqbal";
let message1 = `${famousePerson}, "have a very greatfull and peacefull poetry."`;
...
let authorName = "Imam Ahmed Raza";
let message2 = `${authorName}, "is a great Scholar in the world."`;
...
let favoriteNumber1 = 9;
let message3 = `"My favorite number is" ${favoriteNumber1}`;
...
let favoriteNumber2 = 9;
let message4 = `"My Wedding date is" ${favoriteNumber2}`;
...
let myName = "Muhammad Tahir Hasni";
let message5 = `" ${myName} is starting Programming on 06 february 2024 at Govrnor House Karachi"`;
...
let names1 = ["Taimoor", "Iqbal", "Shakil",];
...
let transport = ["Chicken Biryani", "Beef Biryani", "Mutton Biryani"];
...
let guests1 = ["Muhammad Shakil", "Muhammad Ibrahim", "Muhammad Raof"];
...
let guests2 = ["Muhammad Zubair", "Muhammad Jalil", "Muhammad Nawaz"];
